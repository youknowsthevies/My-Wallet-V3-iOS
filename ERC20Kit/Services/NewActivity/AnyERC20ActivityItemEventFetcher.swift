//
//  AnyERC20ActivityItemEventFetcher.swift
//  ERC20Kit
//
...
public final class AnyERC20ActivityItemEventFetcher<Token: ERC20Token>: ActivityItemEventFetcherAPI {
    ...
    public init(swapActivityEventService: AnyERC20SwapActivityItemEventsService<Token>,
         transactionalActivityEventService: AnyERC20TransactionalActivityItemEventsService<Token>,
