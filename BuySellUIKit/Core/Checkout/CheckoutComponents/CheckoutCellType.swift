...
extension CheckoutCellType.LineItemType {
    ...
    func presenter(analyticsRecorder: AnalyticsEventRecording & AnalyticsEventRelayRecording) -> LineItemCellPresenting {
        isCopyable ? defaultCopyablePresenter(analyticsRecorder: analyticsRecorder) : defaultPresenter()
    }
    ...
    func defaultCopyablePresenter(analyticsRecorder: AnalyticsEventRecording & AnalyticsEventRelayRecording) -> PasteboardingLineItemCellPresenter {
