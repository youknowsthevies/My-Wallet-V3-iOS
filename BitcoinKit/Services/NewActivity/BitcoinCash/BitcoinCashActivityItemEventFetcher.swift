//
//  BitcoinCashActivityItemEventFetcher.swift
//  BitcoinKit
//
...
public final class BitcoinCashActivityItemEventFetcher: ActivityItemEventFetcherAPI {
    ...
    public init(swapActivityEventService: BitcoinCashSwapActivityItemEventsService,
                transactionalActivityEventService: BitcoinCashTransactionalActivityItemEventsService,
