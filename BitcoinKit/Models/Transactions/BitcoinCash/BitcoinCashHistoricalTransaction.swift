...
public class BitcoinCashHistoricalTransaction: Decodable, HistoricalTransaction, Tokenized {
    ...
    public struct Output: Decodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            amount = CryptoValue.bitcoinCashFromSatoshis(int: satoshis)
    ...
    required public init(from decoder: Decoder) throws {
        ...
        self.amount = CryptoValue.createFromMinorValue(abs(value), assetType: .bitcoinCash)
        ...
        fee = CryptoValue.bitcoinCashFromSatoshis(int: feeValue)
