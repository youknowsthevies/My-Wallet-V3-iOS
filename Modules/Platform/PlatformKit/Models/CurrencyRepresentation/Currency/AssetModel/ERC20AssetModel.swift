...
public struct ERC20AssetModel: AssetModel, Hashable {
    ...
    init?(assetResponse: SupportedAssetsResponse.Asset, sortIndex: Int) {
        ...
        self.logoPngUrl = assetResponse.type.logoPngUrl
...
extension ERC20AssetModel {
    static let ogn = ERC20AssetModel(code: "OGN",
                                     ...
                                     spotColor: "1A82FF",
                                     sortIndex: 101)
    static let enj = ERC20AssetModel(code: "ENJ",
                                     ...
                                     spotColor: "624DBF",
                                     sortIndex: 102)
    static let comp = ERC20AssetModel(code: "COMP",
                                      ...
                                      spotColor: "00D395",
                                      sortIndex: 103)
    static let link = ERC20AssetModel(code: "LINK",
                                      ...
                                      spotColor: "2A5ADA",
                                      sortIndex: 104)
    static let tbtc = ERC20AssetModel(code: "TBTC",
                                      ...
                                      spotColor: nil,
                                      sortIndex: 105)
    static let wbtc = ERC20AssetModel(code: "WBTC",
                                      ...
                                      spotColor: nil,
                                      sortIndex: 106)
    static let snx = ERC20AssetModel(code: "SNX",
                                     ...
                                     spotColor: nil,
                                     sortIndex: 107)
    static let sushi = ERC20AssetModel(code: "SUSHI",
                                       ...
                                       spotColor: nil,
                                       sortIndex: 108)
    static let zrx = ERC20AssetModel(code: "ZRX",
                                     ...
                                     spotColor: "000000",
                                     sortIndex: 109)
    static let usdc = ERC20AssetModel(code: "USDC",
                                      ...
                                      spotColor: "2775CA",
                                      sortIndex: 110)
    static let uni = ERC20AssetModel(code: "UNI",
                                     ...
                                     spotColor: "FF007A",
                                     sortIndex: 111)
    static let dai = ERC20AssetModel(code: "DAI",
                                     ...
                                     spotColor: "F5AC37",
                                     sortIndex: 112)
    static let bat = ERC20AssetModel(code: "BAT",
