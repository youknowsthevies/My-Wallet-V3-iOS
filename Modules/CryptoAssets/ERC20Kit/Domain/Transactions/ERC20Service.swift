...
public class AnyERC20Service<Token: ERC20Token>: ERC20ServiceAPI, ValidateTransactionAPI {
    ...
    private let transfer: (EthereumAddress, ERC20TokenValue<Token>) -> Single<EthereumTransactionCandidate>
    ...
    public func transfer(to: EthereumAddress, amount cryptoValue: ERC20TokenValue<Token>) -> Single<EthereumTransactionCandidate> {
...
public class ERC20Service<Token: ERC20Token>: ERC20API, ERC20TransactionEvaluationAPI {
    ...
    public func transfer(proposal: ERC20TransactionProposal<Token>, to address: EthereumAddress) -> Single<EthereumTransactionCandidate> {
    ...
    private func buildTransactionCandidate(
        ...
        return handlePendingTransaction
            ...
            .flatMap(weak: self) { (self, validatedInputs) -> Single<EthereumTransactionCandidate> in
                self.transferTransaction(to: to, amount: tokenAmount, fee: validatedInputs.fee)
            }
    }
    ...
    private func transferTransaction(to: EthereumAddress, amount: BigUInt, fee: EthereumTransactionFee) -> Single<EthereumTransactionCandidate> {
        let candidate = EthereumTransactionCandidate(
            ...
            value: amount,
            data: nil,
            transferType: .erc20Transfer(contract: Token.contractAddress.ethereumAddress)
        )
