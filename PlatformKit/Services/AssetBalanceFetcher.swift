    ...
    private lazy var setup: Void = {
        Observable
            ...
            .map { payload in
                ...
                case .crypto:
                    let tradingBalance = trading.balance?.available ?? .zero(baseCurrencyType)
                    let savingBalance = savings.balance?.available ?? .zero(baseCurrencyType)
                    return MoneyValueBalancePairs(
    ...
    private lazy var setup: Void = {
        ...
        Observable
            ...
            .map { payload in
                ...
                case .crypto:
                    let tradingBalance = trading.balance?.withdrawable ?? .zero(baseCurrencyType)
                    let savingBalance = savings.balance?.withdrawable ?? .zero(baseCurrencyType)
                    return MoneyValueBalancePairs(
