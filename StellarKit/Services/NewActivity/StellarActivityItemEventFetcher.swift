//
//  StellarActivityItemEventFetcher.swift
//  StellarKit
//
...
public final class StellarActivityItemEventFetcher: ActivityItemEventFetcherAPI {
    ...
    public init(swapActivityEventService: StellarSwapActivityItemEventsService,
                transactionalActivityEventService: StellarTransactionalActivityItemEventsService,
